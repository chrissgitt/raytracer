...
// sphere
double cgRT::RM::SDF::Sphere(const qbVector<double> &p, const qbVector<double> &center, const qbVector<double> &parms){
    return (p - center).norm() - parms.GetElement(0);
}

// torus
double cgRT::RM::SDF::Torus(const qbVector<double> &p, const qbVector<double> &center, const qbVector<double> &parms){
...
// box
double cgRT::RM::SDF::Box(const qbVector<double> &p, const qbVector<double> &center, const qbVector<double> &parms){
